...
> [!note]
>
> → [Open the **fullscreen** demo page](/mantine-video/fullscreen) → [Open the **homepage-style** demo page](/mantine-video/homepage) (both pages live outside the docs layout, full‑bleed)
